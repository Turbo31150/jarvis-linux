...
"/home/turbo/jarvis-linux\.venv\Scripts\python.exe" -c "import asyncio; from src.orchestrator import run_hybrid; asyncio.run(run_hybrid(cwd='/home/turbo/jarvis-linux'))"
echo.

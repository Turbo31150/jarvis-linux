...
"/home/turbo/jarvis-linux\.venv\Scripts\python.exe" -c "import asyncio; from src.orchestrator import run_interactive; asyncio.run(run_interactive(cwd='F:/BUREAU/turbo'))"
echo.

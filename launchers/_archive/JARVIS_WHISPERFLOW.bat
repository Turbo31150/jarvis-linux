...
start /min "JARVIS-WS-Backend" cmd /c "cd /d /home/turbo/jarvis-linux && /home/turbo\.local\bin\uv.exe run python -m python_ws.server"
...
if %errorlevel% equ 0 (
    ...
    cd /d /home/turbo/jarvis-linux\whisperflow
    electron .
) else (

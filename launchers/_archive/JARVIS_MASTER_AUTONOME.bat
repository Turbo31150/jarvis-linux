...
start "JARVIS-Proxy" /min cmd /c "cd /d /home/turbo/jarvis-linux && node canvas\direct-proxy.js"
timeout /t 3 /nobreak >nul

:: 2. Bot Telegram — kill existant + restart
echo [2/4] Bot Telegram...
start "JARVIS-Telegram" /min cmd /c "cd /d /home/turbo/jarvis-linux && node canvas\telegram-bot.js"
timeout /t 2 /nobreak >nul

:: 3. Orchestrateur Autonome (13 taches cron)
echo [3/4] Orchestrateur Autonome...
start "JARVIS-Orchestrator" /min cmd /c "cd /d /home/turbo/jarvis-linux\cowork\dev && python autonomous_orchestrator.py --watch"
timeout /t 2 /nobreak >nul

:: 4. Master Autonome (vagues en cascade)
echo [4/4] Master Autonome (vagues)...
start "JARVIS-Master" /min cmd /c "cd /d /home/turbo/jarvis-linux && python cowork\dev\jarvis_master_autonome.py"
timeout /t 2 /nobreak >nul

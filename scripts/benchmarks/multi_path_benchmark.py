...
TURBO_ROOT = Path("/home/turbo/jarvis-linux")
...
async def path_p4_external(client: httpx.AsyncClient, node_id: str, prompt: str) -> tuple[str, int, float]:
    ...
    if "gemini" in node_id.lower():
        cmd = ["node", "/home/turbo/jarvis-linux/gemini-proxy.js", "--json", prompt]
    else:
        cmd = ["node", "/home/turbo/jarvis-linux/claude-proxy.js", "--json", "--budget", "0.30", prompt]

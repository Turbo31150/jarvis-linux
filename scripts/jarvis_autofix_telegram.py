...
Usage: python /home/turbo/jarvis-linux/scripts/jarvis_autofix_telegram.py
"""
...
if __name__ == "__main__":
    ...
    boot = run('python "/home/turbo/jarvis-linux/scripts/jarvis_boot_telegram.py"', timeout=30)
    if boot:
        # Extract grade line
    ...
    for issue in issues:
        if "M2 OFFLINE" in issue:
            ...
            r = run('python "/home/turbo/jarvis-linux/scripts/jarvis_unified_boot.py" --phase python_services --skip openclaw', timeout=60)
            fixes_done += 1
    ...
    boot2 = run('python "/home/turbo/jarvis-linux/scripts/jarvis_boot_telegram.py"', timeout=30)
    if boot2:

...
def gen_pipelines():
    ...
    cluster_ops = [
        ...
        ("cluster_network_diag", "diagnostic reseau du cluster", "powershell:Test-Connection 192.168.1.26 -Count 2;;powershell:Test-Connection 192.168.1.113 -Count 2;;powershell:Test-Connection 127.0.0.1 -Count 2;;jarvis_tool:network_report", "pipeline", "M1,M2,M3"),
    ...
    monitoring = [
        ...
        ("mon_network_latency", "latence reseau du cluster", "powershell:Test-Connection 127.0.0.1 -Count 5;;powershell:Test-Connection 192.168.1.26 -Count 5;;powershell:Test-Connection 192.168.1.113 -Count 5;;jarvis_tool:latency_report", "pipeline", "M1,M2,M3"),

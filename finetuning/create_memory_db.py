...
DB_PATH = Path("/home/turbo/jarvis-linux/finetuning/memoire_finetuning.db")
...
def _patched_params4bit_new(cls, data=None, requires_grad=True, **kwargs):
    ...
    config = {
        ...
        "offload_folder": "/home/turbo/jarvis-linux/finetuning/offload",
    ...
    for ds_type, fpath, num, size, jpct, gpct in datasets:
        full_path = f"/home/turbo/jarvis-linux/finetuning/{fpath}"
        file_size = None
        try:

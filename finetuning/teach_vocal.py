...
conn = sqlite3.connect('/home/turbo/jarvis-linux/data/jarvis.db')
cur = conn.cursor()
...
count_before = len(examples)
conn2 = sqlite3.connect('/home/turbo/jarvis-linux/data/etoile.db')
cur2 = conn2.cursor()
...
# === SAUVEGARDE ===
outfile = '/home/turbo/jarvis-linux/finetuning/dataset/jarvis_vocal_teaching.jsonl'
with open(outfile, 'w', encoding='utf-8') as f:
    for ex in examples:
        f.write(json.dumps(ex, ensure_ascii=False) + '\n')

# Ajouter au dataset principal
with open('/home/turbo/jarvis-linux/finetuning/dataset/jarvis_final_train.jsonl', 'a', encoding='utf-8') as f:
    for ex in examples:
        f.write(json.dumps(ex, ensure_ascii=False) + '\n')
...
total = len(Path('/home/turbo/jarvis-linux/finetuning/dataset/jarvis_final_train.jsonl').read_text(encoding='utf-8').splitlines())

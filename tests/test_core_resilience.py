...
def test_gpu_scheduler_presence():
    ...
    scheduler = Path("/home/turbo/jarvis-linux/src/gpu_scheduler.py")
...
def test_tts_fallback():
    ...
    tts_script = Path("/home/turbo/jarvis-linux/scripts/jarvis-tts.sh")

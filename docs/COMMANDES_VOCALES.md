...
| backup_express | "backup express" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Bac... (confirm) |
...
| fin_journee | "fin de journee" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Fin... > pause 1s > Start-Process ms-settings:nightlight > pause 1s > ... |
...
| routine_depart | "routine depart" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Aut... > pause 1s > MinimizeAll > pause 1s > powercfg /setactive a1841... (confirm) |
...
| dev_morning_setup | "dev morning" | cd /home/turbo/jarvis-linux; git pull --rebase 2>&1 | Out-String > pause 1s > Ouvrir code > pause 2s > Ouvrir wt > pause 1s > ... |
| dev_deep_work | "deep work" | Stop-Process -Name 'discord','telegram','slack' -F... > pause 1s > MinimizeAll > pause 1s > Settings > pause 1s > Ouv... |
| dev_standup_prep | "standup prep" | cd /home/turbo/jarvis-linux; git log --since='yesterday' --... > pause 1s > Web: https://github.com > pause 1s > Web: http://1... |
| dev_deploy_check | "check avant deploy" | cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd /home/turbo/jarvis-linux; git status -sb > docker ps --format 'tabl... |
| dev_friday_report | "rapport vendredi" | cd /home/turbo/jarvis-linux; 'Commits cette semaine:'; git ... > cd /home/turbo/jarvis-linux; $py = (Get-ChildItem src/*.py ... > Web: ... |
| dev_code_review_setup | "setup code review" | Web: https://github.com/pulls > pause 1s > Ouvrir code > pause 1s > cd /home/turbo/jarvis-linux; git diff --stat 2>&1 | Out-St... |
...
| routine_nuit_urgence | "urgence nuit" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Eme... > pause 1s > MinimizeAll > Lock PC > pause 2s > Veille (confirm) |
...
| mode_daily_report | "rapport quotidien" | cd /home/turbo/jarvis-linux; 'Commits du jour:'; git log --... > cd /home/turbo/jarvis-linux; $py = (Get-ChildItem src/*.py ... > Web: ... |
...
| mode_refactoring | "mode refactoring" | Ouvrir code > pause 1s > cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd /home/turbo/jarvis-linux; git diff --stat ... |
| mode_testing_complet | "mode testing complet" | Ouvrir wt > pause 1s > cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd /home/turbo/jarvis-linux; & '/home/turbo\... |
| mode_deploy_checklist | "checklist deploy" | cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd F:... |
...
| mode_retrospective | "mode retro" | cd /home/turbo/jarvis-linux; 'Commits semaine:'; git log --... > Web: https://www.notion.so > pause 1s > Web: https://calendar... |
| mode_demo | "mode demo" | DisplaySwitch.exe /clone > pause 2s > Web: http://127.0.0.1:8080 > pause 1s > Web: https://github.com > pause 1s > "D... |
| mode_scrum_master | "mode scrum" | Web: https://github.com/projects > pause 1s > Web: https://calendar.google.com > pause 1s > cd /home/turbo/jarvis-linux; git l... |
...
| sim_pause_longue | "longue pause" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Aut... > MinimizeAll > pause 1s > Start-Process ms-settings:nightlight... |
...
| sim_tout_fermer_propre | "ferme tout proprement" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Cle... > Stop-Process -Name 'code','wt','obs64','discord','... > pause... |
| sim_fin_journee_complete | "fin de journee complete" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Fin... > cd /home/turbo/jarvis-linux; $c = (git log --since='today' ... > Stop-... (confirm) |
| sim_weekend_mode | "mode weekend complet" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Wee... > Stop-Process -Name 'code','wt','lmstudio' -Force -... > pause... |
...
| sim_backup_hebdo | "backup hebdomadaire" | cd /home/turbo/jarvis-linux; git add -A; git commit -m 'Wee... > cd /home/turbo/jarvis-linux; $c = (git log --since='1 week ... > $d = ... (confirm) |
...
| sim_db_health_check | "health check des bases" | $j = (Get-Item /home/turbo/jarvis-linux\data\jarvis.db -Err... > sqlite3 /home/turbo/jarvis-linux\data\jarvis.db 'PRAGMA int... > sqlit... |
| sim_db_backup | "backup les bases" | $d = Get-Date -Format 'yyyy-MM-dd_HHmm'; Copy-Item... |
| sim_db_stats | "stats des bases" | sqlite3 /home/turbo/jarvis-linux\data\jarvis.db '.tables' 2... > sqlite3 /home/turbo/jarvis-linux\data\jarvis.db 'SELECT "sk... > sqlit... |
...
| sim_code_review_prep | "prepare la code review" | cd /home/turbo/jarvis-linux; git log --oneline -5 2>&1 | Out-String > cd /home/turbo/jarvis-linux; git diff --stat HEAD~3 2>&1 | Out-St... |
...
| sim_standup_meeting | "prepare le standup" | cd /home/turbo/jarvis-linux; "=== HIER ==="; git log --sinc... > cd /home/turbo/jarvis-linux; "=== AUJOURD'HUI ==="; git log... > cd F:... |
...
| sim_fullstack_build | "build complet du projet" | cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > "Buil... |
| sim_deploy_check | "check avant deploiement" | cd /home/turbo/jarvis-linux; git status -sb 2>&1 | Out-String > cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd F:\... |
| sim_git_release | "fais une release" | cd /home/turbo/jarvis-linux; $v = git describe --tags --abb... > cd /home/turbo/jarvis-linux; git log --oneline -10 2>&1 | Out-String >... |
...
| sim_doc_session | "session documentation" | code /home/turbo/jarvis-linux\docs 2>$null > pause 2s > Web: https://devdocs.io > pause 1s > Web: https://markdownlivepreview.... |
| sim_doc_generate | "genere toute la doc" | cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > "Docu... |
...
| sim_model_eval | "evalue les modeles" | cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > "Evaluation modeles terminee — voir data/benchmark... |
...
| sim_deploy_vercel | "deploie sur vercel" | cd /home/turbo/jarvis-linux; git status -sb 2>&1 | Out-String > cd /home/turbo/jarvis-linux; git push origin main 2>&1 | Out-String > W... |
...
| sim_datascience_setup | "mode data science" | cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > Web: https://huggingface.co/datasets > pause 1s > nvidia-smi ... |
...
| sim_jarvis_selfcheck | "auto diagnostic jarvis" | cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > cd /home/turbo/jarvis-linux; & '/home/turbo\.local\bin\u... > $dbs=... |
...
| sim_weekly_review | "review hebdomadaire" | cd /home/turbo/jarvis-linux; "=== COMMITS CETTE SEMAINE ===... > cd /home/turbo/jarvis-linux; $f=git diff --stat HEAD~10 2>&... > cd F:... |

...
**Files:**
- Modify: `/home/turbo/jarvis-linux/canvas/direct-proxy.js` (section ETOILE_SUMMARY ~ligne 102-130)
...
Run: `node /home/turbo/jarvis-linux/canvas/direct-proxy.js` (dans un terminal separe)
...
**Files:**
- Modify: `/home/turbo/jarvis-linux/canvas/direct-proxy.js` (fonction agenticChat ~ligne 440)
...
**Files:**
- Modify: `/home/turbo/jarvis-linux/canvas/direct-proxy.js` (outils query_db et pipeline)
...
**Files:**
- Modify: `/home/turbo/jarvis-linux/canvas/index.html` (fonction addCockpitMsg + CSS)
...
# Relancer
cd /home/turbo/jarvis-linux && node canvas/direct-proxy.js &
```

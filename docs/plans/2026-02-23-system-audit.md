...
Run: `cd /home/turbo/jarvis-linux && uv run python test_system_audit.py`
...
Run: `cd /home/turbo/jarvis-linux && uv run python scripts/system_audit.py`
...
Run: `cd /home/turbo/jarvis-linux && uv run python scripts/system_audit.py --save`

...
**Files:**
- Modify: `/home/turbo/jarvis-linux/pyproject.toml`
...
Run: `cd /home/turbo/jarvis-linux && uv pip install openwakeword edge-tts`
Expected: packages installed successfully

**Step 3: Verify imports work**

Run: `cd /home/turbo/jarvis-linux && python -c "import openwakeword; import edge_tts; print('OK')"`
Expected: `OK`
...
**Files:**
- Create: `/home/turbo/jarvis-linux/src/wake_word.py`
...
Run: `cd /home/turbo/jarvis-linux && python -c "from src.wake_word import WakeWordDetector; print('OK')"`
Expected: `OK`
...
**Files:**
- Modify: `/home/turbo/jarvis-linux/src/whisper_worker.py`
...
Run: `echo "QUIT" | C:/Users/franc/AppData/Local/Programs/Python/Python312/python.exe /home/turbo/jarvis-linux/src/whisper_worker.py`
...
**Files:**
- Create: `/home/turbo/jarvis-linux/src/tts_streaming.py`
...
Run: `cd /home/turbo/jarvis-linux && python -c "from src.tts_streaming import speak_streaming; print('OK')"`
Expected: `OK`
...
**Files:**
- Modify: `/home/turbo/jarvis-linux/src/voice_correction.py`
...
Run: `cd /home/turbo/jarvis-linux && python -c "from src.voice_correction import full_correction_pipeline; print('OK')"`
Expected: `OK`
...
**Files:**
- Modify: `/home/turbo/jarvis-linux/src/voice.py`
...
Run: `cd /home/turbo/jarvis-linux && python -c "from src.voice import listen_voice; print('OK')"`
Expected: `OK`
...
Run: `cd /home/turbo/jarvis-linux && python -c "from src.voice import listen_voice_v2; print('OK')"`
Expected: `OK`
...
**Files:**
- Modify: `/home/turbo/jarvis-linux/src/config.py`
...
Create: `/home/turbo/jarvis-linux/test_voice_v2.py`
...
Run: `cd /home/turbo/jarvis-linux && python test_voice_v2.py`

...
1. Ouvrir `/home/turbo/jarvis-linux\src\mcp_server_sse.py`
...
```powershell
Get-ChildItem /home/turbo/jarvis-linux\src\ | Where-Object { $_.Name -match '(startup_wiring|event_bus_wiring|scheduler_cleanup|health_probe_registry|gpu_guardian|cluster_self_healer|trading_sentinel|perplexity_bridge|smart_retry|daily_report)' }
```

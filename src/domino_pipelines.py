...
DOMINO_PIPELINES: list[DominoPipeline] = [
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_status", "powershell:git -C 'F:/BUREAU/turbo' status --short", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("size_check", "powershell:Get-Item 'F:/BUREAU/turbo/data/etoile.db' | Select-Object Length", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_status", "powershell:git -C 'F:/BUREAU/turbo' status --short", "powershell"),
            DominoStep("run_tests", "powershell:cd F:/BUREAU/turbo && uv run python -m pytest tests/ -q 2>&1", "powershell", on_fail="stop"),
            DominoStep("git_add_commit", "powershell:git -C 'F:/BUREAU/turbo' add -A && git -C 'F:/BUREAU/turbo' commit -m 'auto-deploy'", "powershell"),
            DominoStep("git_push", "powershell:git -C 'F:/BUREAU/turbo' push", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_stash", "powershell:git -C 'F:/BUREAU/turbo' stash", "powershell"),
            DominoStep("apply_fix", "powershell:git -C 'F:/BUREAU/turbo' add -A", "powershell"),
            DominoStep("commit_hotfix", "powershell:git -C 'F:/BUREAU/turbo' commit -m 'hotfix: correction urgente'", "powershell"),
            DominoStep("push_hotfix", "powershell:git -C 'F:/BUREAU/turbo' push", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("get_last_commit", "powershell:git -C 'F:/BUREAU/turbo' log -1 --oneline", "powershell"),
            DominoStep("revert_commit", "powershell:git -C 'F:/BUREAU/turbo' revert HEAD --no-edit", "powershell"),
            DominoStep("push_revert", "powershell:git -C 'F:/BUREAU/turbo' push", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("backup_config", "powershell:Copy-Item 'F:/BUREAU/turbo/.env' 'F:/BUREAU/turbo/.env.bak'", "powershell"),
            DominoStep("run_tests", "powershell:cd F:/BUREAU/turbo && uv run python -m pytest tests/ -q 2>&1", "powershell", on_fail="stop"),
            DominoStep("git_commit_push", "powershell:git -C 'F:/BUREAU/turbo' add -A && git -C 'F:/BUREAU/turbo' commit -m 'safe-deploy' && git -C 'F:/BUREAU/turbo' push", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("check_env_files", "powershell:Get-ChildItem 'F:/BUREAU/turbo' -Recurse -Filter '.env*' | Select-Object FullName", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("check_acl", "powershell:(Get-Acl 'F:/BUREAU/turbo').Access | Select-Object IdentityReference,FileSystemRights", "powershell"),
            DominoStep("check_sensitive", "powershell:Get-ChildItem 'F:/BUREAU/turbo/data' -Filter '*.db' | Select-Object Name,Length,LastWriteTime", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("backup_config", "powershell:Copy-Item 'F:/BUREAU/turbo/.env','F:/BUREAU/turbo/pyproject.toml' -Destination 'F:/BUREAU/turbo/backups/' -Force", "powershell"),
            DominoStep("backup_git", "powershell:git -C 'F:/BUREAU/turbo' bundle create 'F:/BUREAU/turbo/backups/turbo.bundle' --all", "powershell"),
            DominoStep("verify_backup", "powershell:Get-ChildItem 'F:/BUREAU/turbo/backups/' -File | Sort-Object LastWriteTime -Descending | Select-Object -First 5 Name,Length,LastWriteTime", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("list_backups", "powershell:Get-ChildItem 'F:/BUREAU/turbo/backups/' -Filter '*.db*' | Sort-Object LastWriteTime -Descending | Select-Object -First 5 Name,LastWriteTime", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("collect_logs", "powershell:Get-ChildItem F:/BUREAU/turbo/logs -Filter *.log | Measure-Object -Property Length -Sum | Select-Object Count, @{N='SizeMB';E={[math]::Round($_.Sum/1MB,1)}}", "powershell", timeout_s=10),
            DominoStep("archive_old", "powershell:Get-ChildItem F:/BUREAU/turbo/logs -Filter *.log | Where-Object {$_.LastWriteTime -lt (Get-Date).AddDays(-7)} | Compress-Archive -DestinationPath F:/BUREAU/turbo/logs/archive_$(Get-Date -Format yyyyMMdd).zip -Force", "powershell", timeout_s=20, on_fail="skip"),
            DominoStep("purge_archived", "powershell:Get-ChildItem F:/BUREAU/turbo/logs -Filter *.log | Where-Object {$_.LastWriteTime -lt (Get-Date).AddDays(-7)} | Remove-Item -Force", "powershell", timeout_s=10, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_summary", "powershell:git -C F:/BUREAU/turbo log --oneline --since='8 hours ago' | Measure-Object -Line", "powershell", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("quick_git", "bash:cd /home/turbo/jarvis-linux && git status --short | head -10", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_pending", "bash:cd /home/turbo/jarvis-linux && git status --short | wc -l", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("focus_log", "bash:echo \"$(date '+%Y-%m-%d %H:%M') POMODORO START\" >> /home/turbo/jarvis-linux/data/pomodoro_log.txt", "bash", timeout_s=5),
        ],
        category="task_scheduling",
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("dataset_count", "bash:wc -l /home/turbo/jarvis-linux/data/domino_learning_dataset.jsonl", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("dataset_stats", "bash:wc -l /home/turbo/jarvis-linux/data/domino_learning_dataset.jsonl", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("create_note", "bash:echo \"# Notes - $(date '+%Y-%m-%d %H:%M')\" > /home/turbo/jarvis-linux/data/meeting_notes_$(date '+%Y%m%d').md", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("recent_changes", "bash:cd /home/turbo/jarvis-linux && git diff --stat HEAD~3 2>/dev/null || echo 'No recent changes'", "bash", timeout_s=10),
            DominoStep("todo_check", "bash:cd /home/turbo/jarvis-linux && grep -r 'TODO/|FIXME' src/ --include='*.py' -c 2>/dev/null || echo '0'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_gc", "bash:cd /home/turbo/jarvis-linux && git gc --auto 2>&1 | tail -3", "bash", timeout_s=30, on_fail="skip"),
            DominoStep("git_prune", "bash:cd /home/turbo/jarvis-linux && git remote prune origin 2>&1 | head -5", "bash", timeout_s=15, on_fail="skip"),
            DominoStep("git_size", "bash:cd /home/turbo/jarvis-linux && du -sh .git 2>/dev/null || echo '.git size N/A'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("count_dominos", "bash:cd /home/turbo/jarvis-linux && python3 -c \"from src.domino_pipelines import DOMINO_PIPELINES; print(f'{len(DOMINO_PIPELINES)} cascades')\"", "bash", timeout_s=10),
            DominoStep("count_dataset", "bash:wc -l /home/turbo/jarvis-linux/data/domino_learning_dataset.jsonl", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("count_files", "bash:cd /home/turbo/jarvis-linux && find src/ -name '*.py' | wc -l", "bash", timeout_s=10),
            DominoStep("count_lines", "bash:cd /home/turbo/jarvis-linux && wc -l src/*.py src/**/*.py 2>/dev/null | tail -1 || echo 'N/A'", "bash", timeout_s=10, on_fail="skip"),
            DominoStep("git_commits", "bash:cd /home/turbo/jarvis-linux && git rev-list --count HEAD", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("recent_commits", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since='7 days ago' | head -20", "bash", timeout_s=10),
            DominoStep("files_changed", "bash:cd /home/turbo/jarvis-linux && git diff --stat HEAD~10 2>/dev/null | tail -3", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("log_meeting", "bash:echo \"$(date '+%Y-%m-%d %H:%M') MEETING START\" >> /home/turbo/jarvis-linux/data/meeting_log.txt", "bash", timeout_s=5),
        ],
        category="meeting_assistant",
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("python_syntax", "bash:cd /home/turbo/jarvis-linux && python3 -m py_compile src/domino_pipelines.py 2>&1 && echo 'SYNTAX OK' || echo 'SYNTAX ERROR'", "bash", timeout_s=10),
            DominoStep("import_check", "bash:cd /home/turbo/jarvis-linux && python3 -c 'from src.domino_pipelines import DOMINO_PIPELINES; print(f\"{len(DOMINO_PIPELINES)} cascades OK\")' 2>&1", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("random_domino", "bash:cd /home/turbo/jarvis-linux && python3 -c \"import random; from src.domino_pipelines import DOMINO_PIPELINES; dp=random.choice(DOMINO_PIPELINES); print(f'Quiz: {dp.description}')\"", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_today", "powershell:git -C 'F:/BUREAU/turbo' log --oneline --since='midnight' --format='%h %s'", "powershell"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_prune", "powershell:git -C 'F:/BUREAU/turbo' gc --prune=now", "powershell", timeout_s=60),
            ...
            DominoStep("clean_logs", "powershell:Get-ChildItem 'F:/BUREAU/turbo/data/*.log' -ErrorAction SilentlyContinue | Where-Object {$_.LastWriteTime -lt (Get-Date).AddDays(-7)} | Remove-Item -Force 2>$null", "powershell", on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_diff", "powershell:git -C 'F:/BUREAU/turbo' diff --stat HEAD~3", "powershell"),
            DominoStep("lint_check", "powershell:cd F:/BUREAU/turbo && uv run python -m ruff check src/ --statistics 2>&1 | Select-Object -First 20", "powershell", on_fail="skip", timeout_s=30),
            DominoStep("type_check", "powershell:cd F:/BUREAU/turbo && npx tsc --noEmit 2>&1 | Select-Object -Last 5", "powershell", on_fail="skip", timeout_s=30),
            DominoStep("test_quick", "powershell:cd F:/BUREAU/turbo && uv run python -m pytest tests/ -q --tb=no 2>&1 | Select-Object -Last 3", "powershell", on_fail="skip", timeout_s=60),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_status", "bash:cd /home/turbo/jarvis-linux && git status --short", "bash", timeout_s=10),
            DominoStep("git_log", "bash:cd /home/turbo/jarvis-linux && git log --oneline -10", "bash", timeout_s=10),
            DominoStep("git_branch", "bash:cd /home/turbo/jarvis-linux && git branch -vv", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_yesterday", "bash:cd /home/turbo/jarvis-linux && git log --since='yesterday' --oneline", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("clean_pycache", "bash:find /home/turbo/jarvis-linux -type d -name __pycache__ -exec rm -rf {} + 2>/dev/null; echo OK", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_status", "bash:cd /home/turbo/jarvis-linux && git status --short | head -20", "bash", timeout_s=10),
            DominoStep("git_add", "bash:cd /home/turbo/jarvis-linux && git add -A", "bash", timeout_s=10),
            DominoStep("git_commit", "bash:cd /home/turbo/jarvis-linux && git commit -m 'auto: sauvegarde vocale $(date +%Y%m%d_%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_status", "bash:cd /home/turbo/jarvis-linux && git status --short", "bash", timeout_s=10),
            DominoStep("git_push", "bash:cd /home/turbo/jarvis-linux && git push 2>&1 | tail -3", "bash", timeout_s=30),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("env_file", f"bash:test -f /home/turbo/jarvis-linux/.env && echo '.env exists' || echo '.env MISSING'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("log_size", "bash:ls -lh /home/turbo/jarvis-linux/data/*.log 2>/dev/null || echo 'No logs'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("save_state", "python:save_session_state()", "python"),
            DominoStep("git_snapshot", "bash:cd /home/turbo/jarvis-linux && git stash push -m 'session-snapshot-$(date +%Y%m%d_%H%M)' 2>&1 && git stash pop 2>&1 || echo 'Nothing to stash'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax_check", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && echo 'ALL SYNTAX OK'", "bash", timeout_s=15),
            DominoStep("import_check", "bash:cd /home/turbo/jarvis-linux && python -c 'from src.commands import COMMANDS; from src.voice_correction import process_voice_command; from src.domino_pipelines import DOMINO_PIPELINES; print(f\"OK: {len(COMMANDS)} cmds, {len(DOMINO_PIPELINES)} dominos\")'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_status", "bash:cd /home/turbo/jarvis-linux && git log --oneline -3", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_pending", "bash:cd /home/turbo/jarvis-linux && git status --short | wc -l", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_commit", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'auto: fin de journee $(date +%Y%m%d)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15),
            DominoStep("git_push", "bash:cd /home/turbo/jarvis-linux && git push 2>&1 || echo 'Push failed or nothing to push'", "bash", timeout_s=30, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_week", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since='7 days ago' | wc -l", "bash", timeout_s=10),
            DominoStep("git_stats", "bash:cd /home/turbo/jarvis-linux && git diff --stat HEAD~20 2>/dev/null | tail -3", "bash", timeout_s=10),
            DominoStep("db_stats", "python:sqlite3_table_counts('etoile.db')", "python", on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("count_cmds", "bash:cd /home/turbo/jarvis-linux && python -c 'from src.commands import COMMANDS, VOICE_CORRECTIONS; print(f\"{len(COMMANDS)} cmds, {len(VOICE_CORRECTIONS)} corrections\")'", "bash", timeout_s=10),
            DominoStep("count_implicits", "bash:cd /home/turbo/jarvis-linux && python -c 'from src.voice_correction import IMPLICIT_COMMANDS; print(f\"{len(IMPLICIT_COMMANDS)} implicits\")'", "bash", timeout_s=10),
            DominoStep("count_dominos", "bash:cd /home/turbo/jarvis-linux && python -c 'from src.domino_pipelines import DOMINO_PIPELINES; print(f\"{len(DOMINO_PIPELINES)} dominos\")'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_graph", "bash:cd /home/turbo/jarvis-linux && git log --oneline --graph -15", "bash", timeout_s=10),
            DominoStep("git_authors", "bash:cd /home/turbo/jarvis-linux && git shortlog -sn --since='30 days ago' | head -5", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("count_logs", "bash:ls -la /home/turbo/jarvis-linux/data/*.log 2>/dev/null | wc -l", "bash", timeout_s=5),
            DominoStep("archive_old", "powershell:Get-ChildItem 'F:/BUREAU/turbo/data/*.log' | Where-Object {$_.LastWriteTime -lt (Get-Date).AddDays(-7)} | ForEach-Object { Move-Item $_.FullName ($_.FullName + '.archived') -Force }; 'Logs archives'", "powershell", on_fail="skip", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_status", "bash:cd /home/turbo/jarvis-linux && git status --short", "bash", timeout_s=5),
            DominoStep("git_diff_stats", "bash:cd /home/turbo/jarvis-linux && git diff --stat HEAD~1", "bash", timeout_s=10),
            DominoStep("py_lint", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'ALL SYNTAX OK'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax_check", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
            DominoStep("git_add", "bash:cd /home/turbo/jarvis-linux && git add -A", "bash", timeout_s=5),
            DominoStep("git_commit", "bash:cd /home/turbo/jarvis-linux && git commit -m 'deploy: staging $(date +%Y%m%d-%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=10),
            DominoStep("git_push", "bash:cd /home/turbo/jarvis-linux && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("prune_remote", "bash:cd /home/turbo/jarvis-linux && git remote prune origin 2>&1", "bash", timeout_s=15, on_fail="skip"),
            DominoStep("list_merged", "bash:cd /home/turbo/jarvis-linux && git branch --merged main 2>/dev/null | grep -v main | head -10 || echo 'No merged branches'", "bash", timeout_s=10),
            DominoStep("gc", "bash:cd /home/turbo/jarvis-linux && git gc --auto 2>&1", "bash", timeout_s=30, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("count_errors", "bash:grep -ci 'error/|exception/|fail' /home/turbo/jarvis-linux/data/*.log 2>/dev/null || echo '0 errors'", "bash", timeout_s=10),
            DominoStep("recent_errors", "bash:grep -i 'error/|exception' /home/turbo/jarvis-linux/data/*.log 2>/dev/null | tail -5 || echo 'No recent errors'", "bash", timeout_s=10, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("uv_sync", "bash:cd /home/turbo/jarvis-linux && uv sync 2>&1 | tail -3", "bash", timeout_s=30, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_commit", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'backup: full system $(date +%Y%m%d)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("bench_m1", "bash:curl -s --max-time 10 http://127.0.0.1:1234/api/v1/chat -H 'Content-Type: application/json' -d '{\"model\":\"qwen3-8b\",\"input\":\"/nothink/nDis bonjour en 1 mot.\",\"temperature\":0.1,\"max_output_tokens\":50,\"stream\":false,\"store\":false}' 2>/dev/null | head -c 200 || echo 'M1 TIMEOUT'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_save", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'auto: pause midi $(date +%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("save_state", "bash:cd /home/turbo/jarvis-linux && git stash 2>&1 || echo 'Nothing to stash'", "bash", timeout_s=10, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("line_count", "bash:wc -l /home/turbo/jarvis-linux/src/*.py 2>/dev/null || echo 'N/A'", "bash", timeout_s=10),
            DominoStep("file_count", "bash:find /home/turbo/jarvis-linux/src -name '*.py' 2>/dev/null | wc -l || echo 'N/A'", "bash", timeout_s=10),
            DominoStep("git_stats", "bash:cd /home/turbo/jarvis-linux && git log --oneline | wc -l && echo 'commits' 2>/dev/null", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("clear_prefetch", "powershell:Remove-Item /\Windows/Prefetch/* -Force -ErrorAction SilentlyContinue; 'Prefetch cleared'", "powershell", timeout_s=10, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_log_today", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since=midnight 2>/dev/null || echo 'No commits today'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_pull", "bash:cd /home/turbo/jarvis-linux && git pull --ff-only 2>&1 || echo 'Pull failed or up to date'", "bash", timeout_s=15, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_save", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'auto: shutdown $(date +%Y%m%d-%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15, on_fail="skip"),
            DominoStep("git_push", "bash:cd /home/turbo/jarvis-linux && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
            DominoStep("backup_db", "python:backup_etoile_db()", "python", on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_gc", "bash:cd /home/turbo/jarvis-linux && git gc --auto 2>&1", "bash", timeout_s=30, on_fail="skip"),
            DominoStep("clear_temp", "powershell:Remove-Item $env:TEMP/* -Recurse -Force -ErrorAction SilentlyContinue; 'Temp cleared'", "powershell", timeout_s=15, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_save", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'EMERGENCY SAVE $(date +%Y%m%d-%H%M%S)' 2>&1 || echo 'Nothing'", "bash", timeout_s=10),
            DominoStep("git_push", "bash:cd /home/turbo/jarvis-linux && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("bench_m1_qwen8b", "bash:curl -s --max-time 15 http://127.0.0.1:1234/api/v1/chat -H 'Content-Type: application/json' -d '{\"model\":\"qwen3-8b\",\"input\":\"/nothink/nReponds OK en 1 mot.\",\"temperature\":0.1,\"max_output_tokens\":20,\"stream\":false,\"store\":false}' 2>/dev/null | head -c 100 || echo 'M1 TIMEOUT'", "bash", timeout_s=20),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("env_secrets", "bash:grep -rl 'sk-/|password/|secret' /home/turbo/jarvis-linux/src/*.py 2>/dev/null | wc -l || echo '0 files with potential secrets'", "bash", timeout_s=10, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("stash_list", "bash:cd /home/turbo/jarvis-linux && git stash list 2>&1 || echo 'No stashes'", "bash", timeout_s=5),
            DominoStep("stash_pop", "bash:cd /home/turbo/jarvis-linux && git stash pop 2>&1 || echo 'Nothing to pop'", "bash", timeout_s=10, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("show_last", "bash:cd /home/turbo/jarvis-linux && git log --oneline -3", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("warmup", "bash:curl -s --max-time 15 http://127.0.0.1:1234/api/v1/chat -H 'Content-Type: application/json' -d '{\"model\":\"qwen3-8b\",\"input\":\"/nothink/nPing\",\"temperature\":0.1,\"max_output_tokens\":10,\"stream\":false,\"store\":false}' 2>/dev/null | head -c 100 || echo 'Warmup failed'", "bash", timeout_s=20),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("commit_count", "bash:cd /home/turbo/jarvis-linux && git rev-list --count HEAD 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
            DominoStep("branch_count", "bash:cd /home/turbo/jarvis-linux && git branch | wc -l 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
            DominoStep("last_commit", "bash:cd /home/turbo/jarvis-linux && git log --oneline -1 2>/dev/null", "bash", timeout_s=5),
            DominoStep("file_count", "bash:cd /home/turbo/jarvis-linux && git ls-files | wc -l 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_clean", "bash:cd /home/turbo/jarvis-linux && git checkout -- . 2>&1 || echo 'Nothing to clean'", "bash", timeout_s=10, on_fail="skip"),
            DominoStep("clear_cache", "python:clear_all_caches()", "python"),
            DominoStep("uv_sync", "bash:cd /home/turbo/jarvis-linux && uv sync 2>&1 | tail -3", "bash", timeout_s=30, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("backup_etoile", "python:backup_etoile_db()", "python"),
            DominoStep("git_save", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'auto: incremental backup $(date +%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'SYNTAX OK'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'OK'", "bash", timeout_s=10),
            DominoStep("git_add", "bash:cd /home/turbo/jarvis-linux && git add -A", "bash", timeout_s=5),
            DominoStep("git_commit", "bash:cd /home/turbo/jarvis-linux && git commit -m 'auto: deploy $(date +%Y%m%d-%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=10),
            DominoStep("git_push", "bash:cd /home/turbo/jarvis-linux && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("pull", "bash:cd /home/turbo/jarvis-linux && git pull --ff-only 2>&1 || echo 'Up to date'", "bash", timeout_s=15),
            DominoStep("status", "bash:cd /home/turbo/jarvis-linux && git status --short", "bash", timeout_s=5),
            DominoStep("log_today", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since=midnight 2>/dev/null || echo 'No commits today'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_add", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'quick save $(date +%H%M)' 2>&1 || echo 'Nothing'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_save", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'auto: end session $(date +%Y%m%d-%H%M)' 2>&1 || echo 'Nothing'", "bash", timeout_s=15, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("recent_commits", "bash:cd /home/turbo/jarvis-linux && git log --oneline -20 2>/dev/null", "bash", timeout_s=10),
            DominoStep("tags", "bash:cd /home/turbo/jarvis-linux && git tag --sort=-v:refname | head -5 2>/dev/null || echo 'No tags'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("count_all", "bash:wc -l /home/turbo/jarvis-linux/data/*.log 2>/dev/null || echo '0 log files'", "bash", timeout_s=10),
            DominoStep("errors", "bash:grep -ci 'error/|exception/|fail/|critical' /home/turbo/jarvis-linux/data/*.log 2>/dev/null || echo '0 errors'", "bash", timeout_s=10, on_fail="skip"),
            DominoStep("warnings", "bash:grep -ci 'warn/|warning' /home/turbo/jarvis-linux/data/*.log 2>/dev/null || echo '0 warnings'", "bash", timeout_s=10, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("list_all", "bash:cd /home/turbo/jarvis-linux && git branch -a 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
            DominoStep("merged", "bash:cd /home/turbo/jarvis-linux && git branch --merged main 2>/dev/null | grep -v main | head -10 || echo 'No merged branches'", "bash", timeout_s=5),
            DominoStep("prune", "bash:cd /home/turbo/jarvis-linux && git remote prune origin 2>&1 || echo 'Done'", "bash", timeout_s=15, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax_check", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
            DominoStep("git_diff", "bash:cd /home/turbo/jarvis-linux && git diff --stat 2>/dev/null || echo 'No changes'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("lines", "bash:wc -l /home/turbo/jarvis-linux/src/*.py 2>/dev/null", "bash", timeout_s=10),
            DominoStep("files", "bash:find /home/turbo/jarvis-linux/src -name '*.py' 2>/dev/null | wc -l", "bash", timeout_s=5),
            DominoStep("git_size", "bash:du -sh /home/turbo/jarvis-linux/.git 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
            DominoStep("data_size", "bash:du -sh /home/turbo/jarvis-linux/data 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("bench_inference", "bash:curl -s --max-time 15 http://127.0.0.1:1234/api/v1/chat -H 'Content-Type: application/json' -d '{\"model\":\"qwen3-8b\",\"input\":\"/nothink/nExplique en 20 mots ce quest un GPU.\",\"temperature\":0.1,\"max_output_tokens\":100,\"stream\":false,\"store\":false}' 2>/dev/null | head -c 200 || echo 'TIMEOUT'", "bash", timeout_s=20),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("m1_bench", "bash:curl -s --max-time 15 http://127.0.0.1:1234/api/v1/chat -H 'Content-Type: application/json' -d '{\"model\":\"qwen3-8b\",\"input\":\"/nothink/nDis OK.\",\"temperature\":0.1,\"max_output_tokens\":10,\"stream\":false,\"store\":false}' 2>/dev/null | head -c 50 || echo 'M1 TIMEOUT'", "bash", timeout_s=20),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_save", "bash:cd /home/turbo/jarvis-linux && git add -A && git commit -m 'auto: weekend prep $(date +%Y%m%d)' 2>&1 || echo 'Nothing'", "bash", timeout_s=15, on_fail="skip"),
            DominoStep("git_push", "bash:cd /home/turbo/jarvis-linux && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_pull", "bash:cd /home/turbo/jarvis-linux && git pull --ff-only 2>&1 || echo 'Up to date'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("recent", "bash:cd /home/turbo/jarvis-linux && tail -10 data/claude_tool_log.jsonl 2>/dev/null | head -5 || echo 'No logs'", "bash", timeout_s=5),
            DominoStep("errors", "bash:cd /home/turbo/jarvis-linux && grep -ic 'error/|exception' data/claude_tool_log.jsonl 2>/dev/null || echo '0 errors'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("contributors", "bash:cd /home/turbo/jarvis-linux && git shortlog -sn --all 2>/dev/null | head -5 || echo 'Git error'", "bash", timeout_s=5),
            DominoStep("branches", "bash:cd /home/turbo/jarvis-linux && git branch -a 2>/dev/null | wc -l || echo '?'", "bash", timeout_s=5),
            DominoStep("tags", "bash:cd /home/turbo/jarvis-linux && git tag -l 2>/dev/null | wc -l || echo '0 tags'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("changelog", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since='30 days ago' | head -20", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("errors", "bash:cd /home/turbo/jarvis-linux && grep -ic 'error/|exception/|traceback' data/claude_tool_log.jsonl 2>/dev/null || echo '0'", "bash", timeout_s=5),
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'SYNTAX OK'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("check", "bash:cd /home/turbo/jarvis-linux && wc -l README.md 2>/dev/null || echo 'No README.md'", "bash", timeout_s=3),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("pytest", "bash:cd /home/turbo/jarvis-linux && python -m pytest tests/ -q --tb=short 2>/dev/null | tail -10 || echo 'No pytest tests'", "bash", timeout_s=60),
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'All syntax OK'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("cov", "bash:cd /home/turbo/jarvis-linux && python -m pytest --cov=src/ --cov-report=term-missing tests/ 2>/dev/null | tail -15 || echo 'Coverage N/A'", "bash", timeout_s=60),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("sqlite", "bash:cd /home/turbo/jarvis-linux && python -c \"import sqlite3;c=sqlite3.connect('data/etoile.db');print(f'etoile.db: {c.execute(/\"SELECT COUNT(*) FROM sqlite_master WHERE type=///\"table///\"/\").fetchone()[0]} tables')\" 2>/dev/null || echo 'etoile.db N/A'", "bash", timeout_s=5),
            DominoStep("jarvis", "bash:cd /home/turbo/jarvis-linux && python -c \"import sqlite3;c=sqlite3.connect('data/jarvis.db');print(f'jarvis.db: {c.execute(/\"SELECT COUNT(*) FROM sqlite_master WHERE type=///\"table///\"/\").fetchone()[0]} tables')\" 2>/dev/null || echo 'jarvis.db N/A'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK' || echo 'SYNTAX ERROR!'", "bash", timeout_s=10),
            DominoStep("cluster", "bash:curl -s --max-time 3 http://127.0.0.1:1234/api/v1/models 2>/dev/null && echo 'M1 OK' || echo 'M1 DOWN'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("recent", "bash:cd /home/turbo/jarvis-linux && ls -la data/*.log 2>/dev/null | tail -5 || echo 'No log files'", "bash", timeout_s=5),
            DominoStep("errors", "bash:cd /home/turbo/jarvis-linux && grep -i 'error/|exception/|fail' data/*.log 2>/dev/null | tail -10 || echo 'No errors in logs'", "bash", timeout_s=10),
            DominoStep("tts", "python:edge_tts_speak('Analyse des logs terminee.')", "python"),
        ],
        category="monitoring",
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("status", "bash:cd /home/turbo/jarvis-linux && git status -s", "bash", timeout_s=5),
            DominoStep("test", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git", "bash:cd /home/turbo/jarvis-linux && git log --oneline -5", "bash", timeout_s=5),
            DominoStep("status", "bash:cd /home/turbo/jarvis-linux && git status -s | wc -l", "bash", timeout_s=5),
            DominoStep("summary", "python:project_summary()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("integrity", "bash:cd /home/turbo/jarvis-linux && python -c \"import sqlite3;[print(f'{db}: {sqlite3.connect(f/\"data/{db}/\").execute(/\"PRAGMA integrity_check/\").fetchone()[0]}') for db in ['etoile.db','jarvis.db','sniper.db']]\" 2>/dev/null || echo 'Integrity check error'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'SYNTAX ALL OK'", "bash", timeout_s=15),
            DominoStep("summary", "python:project_summary()", "python"),
            DominoStep("cluster", "python:cluster_node_count()", "python"),
            DominoStep("ram", "python:system_memory_usage()", "python"),
            DominoStep("disk", "python:get_disk_usage()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("import_bench", "bash:cd /home/turbo/jarvis-linux && python -c \"import time;s=time.time();from src.commands import COMMANDS;from src.voice_correction import IMPLICIT_COMMANDS;from src.domino_pipelines import DOMINO_PIPELINES;print(f'Import: {time.time()-s:.3f}s')\"", "bash", timeout_s=10),
            DominoStep("ram", "python:system_memory_usage()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("profile", "bash:cd /home/turbo/jarvis-linux && python -c \"import cProfile;import pstats;pr=cProfile.Profile();pr.enable();from src.commands import COMMANDS;pr.disable();ps=pstats.Stats(pr);ps.sort_stats('cumulative');ps.print_stats(5)\" 2>/dev/null || echo 'cProfile error'", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("disk", "python:get_disk_usage()", "python"),
            DominoStep("large_files", "bash:cd /home/turbo/jarvis-linux && find . -name '*.py' -size +100k 2>/dev/null | head -5 || dir /s /b *.py 2>NUL | head -5", "bash", timeout_s=10),
            DominoStep("db_sizes", "bash:ls -lh /home/turbo/jarvis-linux/data/*.db 2>/dev/null || dir F:/BUREAU/turbo/data/*.db 2>NUL", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("week_log", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since='7 days ago'", "bash", timeout_s=5),
            DominoStep("summary", "python:project_summary()", "python"),
            DominoStep("todos", "bash:cd /home/turbo/jarvis-linux && grep -rn 'TODO/|FIXME' src/*.py 2>/dev/null | wc -l || echo '0'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("todos", "bash:cd /home/turbo/jarvis-linux && grep -rn 'TODO/|FIXME/|HACK/|XXX' src/*.py 2>/dev/null | head -20 || echo 'Aucun TODO'", "bash", timeout_s=10),
            DominoStep("loc", "python:count_lines_of_code()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("yesterday", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since='1 day ago'", "bash", timeout_s=5),
            DominoStep("status", "bash:cd /home/turbo/jarvis-linux && git status --short | wc -l", "bash", timeout_s=5),
            DominoStep("summary", "python:project_summary()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("branch", "bash:cd /home/turbo/jarvis-linux && git branch --show-current", "bash", timeout_s=3),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && echo 'OK'", "bash", timeout_s=10),
            DominoStep("tests", "python:test_voice_match('ouvre chrome')", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'ALL OK'", "bash", timeout_s=15),
            DominoStep("tests", "python:test_voice_match('ouvre chrome')", "python"),
            DominoStep("summary", "python:project_summary()", "python"),
            DominoStep("git", "bash:cd /home/turbo/jarvis-linux && git log --oneline -5", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("imports", "bash:cd /home/turbo/jarvis-linux && python -c 'from src.commands import COMMANDS; from src.voice_correction import IMPLICIT_COMMANDS; from src.domino_pipelines import DOMINO_PIPELINES; from src.domino_executor import _PYTHON_REGISTRY; print(\"ALL IMPORTS OK\")'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("push", "bash:cd /home/turbo/jarvis-linux && git add -A && git status --short", "bash", timeout_s=5),
            DominoStep("log_week", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since='5 days ago' | head -15", "bash", timeout_s=5),
            DominoStep("summary", "python:project_summary()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("status", "bash:cd /home/turbo/jarvis-linux && git status --short", "bash", timeout_s=5),
            DominoStep("stash", "bash:cd /home/turbo/jarvis-linux && git stash list 2>/dev/null || echo 'Aucun stash'", "bash", timeout_s=5),
            DominoStep("branches", "bash:cd /home/turbo/jarvis-linux && git branch -a 2>/dev/null | head -10", "bash", timeout_s=5),
            DominoStep("tags", "bash:cd /home/turbo/jarvis-linux && git tag -l | tail -5 2>/dev/null || echo 'Aucun tag'", "bash", timeout_s=5),
            DominoStep("log", "bash:cd /home/turbo/jarvis-linux && git log --oneline -5", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("reflog", "bash:cd /home/turbo/jarvis-linux && git reflog --oneline -10", "bash", timeout_s=5),
            DominoStep("stash", "bash:cd /home/turbo/jarvis-linux && git stash list 2>/dev/null || echo 'Aucun stash'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("lint", "bash:cd /home/turbo/jarvis-linux && ruff check src/ 2>/dev/null | tail -5 || echo 'ruff non installe'", "bash", timeout_s=15),
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
            DominoStep("loc", "python:count_lines_of_code()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'SYNTAX OK'", "bash", timeout_s=15),
            DominoStep("git_add", "bash:cd /home/turbo/jarvis-linux && git add -A && git status --short", "bash", timeout_s=5),
            DominoStep("commit", "bash:cd /home/turbo/jarvis-linux && git diff --cached --stat", "bash", timeout_s=5),
            DominoStep("push", "bash:cd /home/turbo/jarvis-linux && git push origin main 2>&1 | tail -3", "bash", timeout_s=30),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("pull", "bash:cd /home/turbo/jarvis-linux && git pull --rebase 2>&1 | tail -3", "bash", timeout_s=15),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("log_week", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since='1 week ago'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_clean_check", "bash:cd /home/turbo/jarvis-linux && git status --short | wc -l", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_issues", "bash:cd /home/turbo/jarvis-linux && git log --oneline --grep='fix' -5 2>/dev/null", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("git_secrets", "bash:cd /home/turbo/jarvis-linux && git log --oneline --diff-filter=A -- '*.env' '*.key' '*.pem' 2>/dev/null | head -3 || echo 'Aucun secret commite'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'SYNTAX OK'", "bash", timeout_s=15),
            DominoStep("imports", "bash:cd /home/turbo/jarvis-linux && python -c 'from src.commands import COMMANDS; from src.voice_correction import IMPLICIT_COMMANDS; from src.domino_pipelines import DOMINO_PIPELINES; from src.domino_executor import _PYTHON_REGISTRY; print(\"IMPORTS OK\")'", "bash", timeout_s=10),
            DominoStep("summary", "python:project_summary()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("save", "bash:cd /home/turbo/jarvis-linux && git add -A && git stash 2>/dev/null; echo 'Work saved'", "bash", timeout_s=10),
            DominoStep("stats", "python:project_summary()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("sizes", "bash:cd /home/turbo/jarvis-linux && ls -lh data/*.db 2>/dev/null || dir data/*.db", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax_all", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'ALL SYNTAX OK'", "bash", timeout_s=15),
            DominoStep("imports", "bash:cd /home/turbo/jarvis-linux && python -c 'from src.commands import COMMANDS; from src.voice_correction import IMPLICIT_COMMANDS; from src.domino_pipelines import DOMINO_PIPELINES; print(\"ALL IMPORTS OK\")'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("validate", "bash:cd /home/turbo/jarvis-linux && python -c \"import json,glob; errs=0; [print(f'{f}: OK') if json.load(open(f)) else None for f in glob.glob('data/*.json')[:10]]\" 2>&1 | head -15 || echo 'Erreur validation'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("schema", "bash:cd /home/turbo/jarvis-linux && python -c \"import sqlite3; c=sqlite3.connect('data/etoile.db'); [print(r[0]) for r in c.execute('SELECT name FROM sqlite_master WHERE type=/\"table/\" ORDER BY name')]\"", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("count", "bash:cd /home/turbo/jarvis-linux && wc -l src/*.py 2>/dev/null || echo 'wc non disponible'", "bash", timeout_s=5),
            DominoStep("files", "bash:cd /home/turbo/jarvis-linux && find src -name '*.py' -type f 2>/dev/null | wc -l || echo '?'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("ci_status", "bash:cd /home/turbo/jarvis-linux && git log --oneline -3", "bash", timeout_s=5),
            DominoStep("syntax_check", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && echo 'ALL OK'", "bash", timeout_s=15),
            DominoStep("git_add", "bash:cd /home/turbo/jarvis-linux && git add -A && git status --short", "bash", timeout_s=5),
            DominoStep("git_push", "bash:cd /home/turbo/jarvis-linux && git push origin main 2>&1 | tail -3", "bash", timeout_s=30),
    ...
    DominoPipeline(
        ...
        steps=[
            ...
            DominoStep("diff", "bash:cd /home/turbo/jarvis-linux && git diff HEAD~1 --stat", "bash", timeout_s=10),
        ],
        category="ci_cd",
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("git_today", "bash:cd /home/turbo/jarvis-linux && git log --oneline --since='1 day ago'", "bash", timeout_s=5),
            DominoStep("stats", "python:count_commands()", "python"),
            DominoStep("corrections", "python:count_voice_corrections()", "python"),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("branch", "bash:cd /home/turbo/jarvis-linux && git branch --show-current", "bash", timeout_s=3),
            DominoStep("diff_stats", "bash:cd /home/turbo/jarvis-linux && git diff --stat", "bash", timeout_s=5),
            DominoStep("log_recent", "bash:cd /home/turbo/jarvis-linux && git log --oneline -10", "bash", timeout_s=5),
            DominoStep("syntax", "bash:cd /home/turbo/jarvis-linux && python -m py_compile src/commands.py && echo 'Syntax OK'", "bash", timeout_s=10),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("env_check", r"bash:cd /home/turbo/jarvis-linux && grep -r 'DRY_RUN\|ENABLE_\|DISABLE_\|FEATURE_' .env 2>/dev/null || echo 'Pas de .env ou pas de flags'", "bash", timeout_s=5),
            DominoStep("config_check", r"bash:cd /home/turbo/jarvis-linux && grep -rn 'DRY_RUN\|ENABLE_\|FEATURE_' src/config*.py 2>/dev/null | head -10 || echo 'Pas de flags dans config'", "bash", timeout_s=5),
    ...
    DominoPipeline(
        ...
        steps=[
            DominoStep("fetch", "bash:cd /home/turbo/jarvis-linux && git fetch --all 2>&1 | tail -3", "bash", timeout_s=15),
            DominoStep("status", "bash:cd /home/turbo/jarvis-linux && git status --short", "bash", timeout_s=5),
            DominoStep("behind", "bash:cd /home/turbo/jarvis-linux && git log HEAD..origin/main --oneline 2>/dev/null || echo 'A jour'", "bash", timeout_s=5),
...
for _pipeline in DOMINO_PIPELINES:
    for _step in _pipeline.steps:
        if "F:/BUREAU/turbo" in _step.action:
            _step.action = _step.action.replace("F:/BUREAU/turbo", _TURBO_DIR)
        if "/home/turbo/jarvis-linux" in _step.action:
            _step.action = _step.action.replace("/home/turbo/jarvis-linux", _TURBO_DIR_FWD)

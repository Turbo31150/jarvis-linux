...
- **28 modules** Python dans `/home/turbo/jarvis-linux\src\`
- **Canvas standalone**: `/home/turbo/jarvis-linux\canvas\` (direct-proxy.js, autolearn.js, index.html)
- **Electron desktop**: `/home/turbo/jarvis-linux\electron\`
- **Trading pipeline**: `/home/turbo/jarvis-linux\scripts\trading_v2\`
- **Dashboard**: `/home/turbo/jarvis-linux\dashboard\`
- **SDK agents**: `/home/turbo/jarvis-linux\src\agents.py`

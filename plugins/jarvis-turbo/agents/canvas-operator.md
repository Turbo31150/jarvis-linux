...
- **Proxy**: Node.js server (`/home/turbo/jarvis-linux/canvas/direct-proxy.js`) on port 18800
- **UI**: Single-page app (`/home/turbo/jarvis-linux/canvas/index.html`) — Command Center v2
- **Autolearn Engine**: `/home/turbo/jarvis-linux/canvas/autolearn.js` — 3 pillars (memory, tuning, review)
- **Data**: `/home/turbo/jarvis-linux/canvas/data/` — memory.json, routing_scores.json, autolearn_history.json
- **Launcher**: `/home/turbo/jarvis-linux/canvas/start.bat`
...
# Restart
cd /home/turbo/jarvis-linux/canvas && start "" cmd /c "node direct-proxy.js"
```
